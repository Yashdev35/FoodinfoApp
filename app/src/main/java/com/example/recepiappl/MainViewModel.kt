...
class MainViewModel : ViewModel() {
    data class RecipeState(//creating a data class to know if the suspended function has provided us with the data or not
    ...
    val categoryState: State<RecipeState> = _categoryState//this will be used to get the state of our recipe and to update the ui when state changes
    init {
